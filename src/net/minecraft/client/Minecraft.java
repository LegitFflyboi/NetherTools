...
import org.cloudchan.resilient.gui.GuiInGameHook;
...
public class Minecraft implements IThreadListener {
	...
	// ==== Resilient ==== \\
	public org.cloudchan.resilient.core.Resilient resilient;
	...
	private void startGame() throws LWJGLException {
		...
		try {
			...
			this.gameSettings.enableVsync = true;
			this.gameSettings.saveOptions();
		}
		
		// TODO: Resilient
		resilient = new Resilient();
	...
	private void func_175609_am() throws LWJGLException {
		...
		Display.setTitle(org.cloudchan.resilient.core.Resilient.NAME + " " + org.cloudchan.resilient.core.Resilient.VERSION);
	...
	private void runGameLoop() throws IOException {
		...
		while (getSystemTime() >= this.debugUpdateTime + 1000L) {
			...
			this.debug = String.format("%d fps (%d chunk update%s) T: %s%s%s%s%s",
					...
					this.gameSettings.clouds = true;
					this.gameSettings.chatColours = true;
