...
public class GuiIngame extends Gui {
	...
	private void func_180475_a(ScoreObjective p_180475_1_, ScaledResolution p_180475_2_) {
		...
		for (Iterator var7 = var21.iterator(); var7
			...
			var10 = ScorePlayerTeam.formatPlayerName(var9, var8.getPlayerName()) + ": " + EnumChatFormatting.GREEN
					+ var8.getScorePoints();
		}
		...
		while (var12.hasNext()) {
			...
			String var16 = EnumChatFormatting.BLUE + "" + var13.getScorePoints();
