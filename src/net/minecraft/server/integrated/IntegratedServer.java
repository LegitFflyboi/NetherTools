...
public class IntegratedServer extends MinecraftServer {
	...
	protected void loadAllWorlds(String p_71247_1_, String p_71247_2_, long seed, WorldType type, String p_71247_6_) {
		...
		for (int var9 = 0; var9 < this.worldServers.length; ++var9) {
			...
			if (var9 == 0) {
				this.worldServers[var9] = (WorldServer) (new WorldServer(this, var7, var8, var10, this.theProfiler))
						.init();

				this.worldServers[var9].initialize(this.theWorldSettings);
			} else {
				this.worldServers[var9] = (WorldServer) (new WorldServerMulti(this, var7, var10, this.worldServers[0],
			...
			if (this.mc.theWorld != null) {
				...
				if (!var10.isDifficultyLocked() && var3.getDifficulty() != var10.getDifficulty()) {
					logger.info("Changing difficulty to {}, from {}",
							new Object[] { var3.getDifficulty(), var10.getDifficulty() });
