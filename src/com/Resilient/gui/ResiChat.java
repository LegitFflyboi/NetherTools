...
public class ResiChat extends GuiScreen
{
    ...
    /** Counts the amount of characters typed */
    int keyCounter = 0;
    
    public ResiChat() {}

    public ResiChat(String p_i1024_1_)
    {
        ...
        if(keyCode != 41){
            ...
            if(keyCode == 14){
                if(keyCounter > 1){
                    ...
                    this.mc.displayGuiScreen(new ResiChat(Resilient.PREFIX));
                }
            }
            ...
            else
            {
                ...
                if (var3.length() > 0)
                {
                    // this.func_175275_f(var3); Sends the message to the server
                }
